	...
	<div id="page">
		...
		<div id="content">
                    ...
                    else if(request.getParameter("action")!=null && request.getParameter("patid")!=null && request.getParameter("patid").length()>0 &&  request.getParameter("action").length()>0 && request.getParameter("action").equalsIgnoreCase("newAppoint"))
                    {
                        ...
                        if(newAppBean==null)
                        {
                            patBean PB=siteDoctorBacking.getPatientById(request.getParameter("patid"));
                            newAppBean=new appointmentsBean("", siteDoctorBacking.AB.SB.id, siteDoctorBacking.AB.id, PB.id, "", null, null, "", "", "", "", "", "");
                            newAppBean.PB=PB;
                        ...
                        {
                            allExamTypesList=siteDoctorBacking.getAllExamTypes();
                    ...
                    <div class="post" id="searchExamRoomsFormDiv">
                        ...
                        <div class="entry">
                            ...
                            %>
                                    ...
                                    <%
                                    if(siteDoctorBacking.selectedTimeslotDivId!=null && siteDoctorBacking.selectedTimeslotDivId.length()>0)
                                    {
                                    %>
                                        enlightDV( document.getElementById("<%= siteDoctorBacking.selectedTimeslotDivId %>"), <%= siteDoctorBacking.selectedExamRoomId %>);
                                    <%
                                    }
                                    %>
            ...
            else if(request.getParameter("action")!=null && request.getParameter("action").length()>0 && request.getParameter("action").equalsIgnoreCase("confirmApp"))
            {
                ...
                appointmentsBean newAppBean=siteDoctorBacking.newAppointment;
            %>
            ...
            %>
                ...
                <div class="post">
                    ...
                    <div class="entry">
                        ...
                        else if(siteDoctorBacking.patientSearchResults!=null && siteDoctorBacking.patientSearchResults.size()>0)
                        {
                            //we have results
                            //ArrayList<patBean> patList=(ArrayList<patBean>)session.getAttribute("patList");
                            
                            ArrayList<patBean> patList=siteDoctorBacking.patientSearchResults;
...
//                        if(siteDoctorBacking.searchedPatientBean!=null)
//                        {
//                            out.println("<br/><br/>");
