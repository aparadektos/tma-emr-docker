...
if(examTypeID.length()>0 && appDuration.length()>0)
{
    ...
    ArrayList<ExamroomsBean> examRoomsResults=siteDoctorBacking.searchForExamroomsByModalityType(AB.SB.id,examTypeBean.getModalityType());
    if(examRoomsResults!=null && examRoomsResults.size()==0)
    {
        siteDoctorBacking.infoMessage=langBacking.getLiteral("message_for_unavailable_examination_rooms");
