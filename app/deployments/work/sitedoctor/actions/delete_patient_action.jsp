...
{    
    ...
    if(siteDoctorBacking.deletePatient(patId)==true)
    {
        //if success response OK 
        siteDoctorBacking.okMessage=langBacking.getLiteral("patient_delete_ok");
    ...
    else
    {
        ...
        siteDoctorBacking.errorMessage=langBacking.getLiteral("patient_delete_failed");
        response.sendRedirect("../patients.jsp");
    }
}
else
