...
{
    TeleAppointmentFileBean selectedFile = siteDoctorBacking.getTeleAppointmentFileById(fileId);
    if(selectedFile!=null)
    {
        byte[] fileByteArray = siteDoctorBacking.downloadTeleAppointmentFile(fileId);
        if(fileByteArray!=null && fileByteArray.length>0)
        {
            ...
            if(userAgent.indexOf("Firefox")>0 || userAgent.indexOf("firefox")>0)
            {
                ...
                response.addHeader("Content-Disposition", "attachment; filename*='UTF-8'" + URLEncoder.encode(selectedFile.getFileName(), "UTF-8"));
            }
            else
            {
        ...
        {
            siteDoctorBacking.errorMessage=langBacking.getLiteral("invalid_file_selected");
