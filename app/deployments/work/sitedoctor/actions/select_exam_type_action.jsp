...
{
    ExamTypeBean examTypeBean=siteDoctorBacking.getExamTypeByID(examTypeId);
    ...
    {
        siteDoctorBacking.errorMessage=langBacking.getLiteral("invalid examTypeId selected");
    }
}
else
{
