...
//    siteDoctorBacking.teleAppointmentsSearchResults=siteDoctorBacking.getAllTeleAppointmentsByDoctorIdAndDate(siteDoctorBacking.AB.docBean.id,submittedDate);
    siteDoctorBacking.appointmentsSearchResults=siteDoctorBacking.getAllLocalAppointmentsBySearch(examRoomId,submittedDate);
}
else
{
//    Date today=new Date();
...
if(siteDoctorBacking.appointmentsSearchResults.size()==0)
{
