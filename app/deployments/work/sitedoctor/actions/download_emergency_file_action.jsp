...
if(erFileId!=null && erFileId.trim().length()>0 && erCaseId!=null && erCaseId.trim().length()>0)
{
    ...
    for(EmergencyCaseBean curErCase : siteDoctorBacking.emergenciesSearchResults)
    {
    ...
    if(selectedErCase!=null)
    {
        ...
        {
            byte[] fileByteArray = siteDoctorBacking.downloadEmergencyFile(selectedErFile.getId());
