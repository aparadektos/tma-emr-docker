...
$("#addPatientForm [title]").wijtooltip();
                        ...
                        <div class="entry">
                            <form id="addPatientForm" method="post" action="actions/add_patient_action.jsp" enctype="multipart/form-data">
                                <table border="0">
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_name_tooltip") %>"/>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_surname_tooltip") %>"/>
                                            <font color="red"><%= langBacking.getLiteral("surname") %>:</font>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_fathers_name_tooltip") %>"/>
                                            <font color="red"><%= langBacking.getLiteral("fathers_name") %>:</font>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_birth_date_tooltip") %>"/>
                                            <font color="red"><%= langBacking.getLiteral("date_of_birth") %>:</font>
                                        </td>
                                        <td>
                                            <%
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_gender_tooltip") %>"/>
                                            <font color="red"><%= langBacking.getLiteral("sex") %>:</font>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_nationality_tooltip") %>"/>
                                            <font color="red"><%= langBacking.getLiteral("nationality") %>:</font>
                                        </td>
                                        <td>
                                            <select name="patNationalityId" id="patNationalityId">
                                                <%
                                                siteDoctorBacking.getAllCountriesAndNationalities(langBacking.lang);
                                                for(CountryBean curNationBean : siteDoctorBacking.getAllCountriesAndNationalitiesList())
                                                {
...
<!--                                            <textarea name="patAddress" id="area" rows="2" cols="50"></textarea>-->
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_ssn_tooltip") %>"/>
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_other_id_tooltip") %>"/>
                                            <font color="orange">
                                    ...
                                    <tr>
                                        <td align="right">
                                            <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("patient_declaration_tooltip") %>"/>
                                            <font color="purple">
                                    ...
                                    <tr>
                                        <td align="right">
                                            <table border="0">
                                                <tr>
                                                    <td valign="bottom">
                                                        <img src="../images/icon_info_small.png" title="<%= langBacking.getLiteral("doctor_declaration_tooltip") %>"/>
                                                    </td>
                                                    <td valign="top">
