                ...
                <div id="content">
                    <div class="post">
                        <div class="entry">
                            ...
                            {
                                selectedConsultant=siteDoctorBacking.DBH.getConsultantById(selectedConsId);
                            }
                            else if(consHash!=null && consHash.length()>0)
                            {
                                selectedConsultant=siteDoctorBacking.getConsultantFromTeleAppointmentsResults(consHash);
                            }
                            ...
                            if(selectedConsultant!=null && selectedConsultant.getId()!=null && selectedConsultant.getId().length()>0)
                            {
                                ...
                                {
                                    selectedConsultant.setPhotoBytes(siteDoctorBacking.DBH.getPhotoBytesByConsultantId(selectedConsultant.getId()));
                                }
