	...
	<div id="page">
            <div id="page-bgtop">
                <div id="content">
                    ...
                    <%
                    ArrayList<MessageBean> recentMessages = siteDoctorBacking.getRecentMessagesByAccountId(siteDoctorBacking.AB.id);
                    for(int i=0; i<recentMessages.size(); i++)
                    {
                        MessageBean curMsg = recentMessages.get(i);
                        String curColor="navy";
                        if(curMsg.getFromAccountBean().id.equals(siteDoctorBacking.AB.id))
                        {
                            curColor="#EEEEEE";
                        }
                        else
