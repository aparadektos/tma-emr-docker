...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body >
        ...
        {
            siteDoctorBacking.selectedPatientToViewHistory = siteDoctorBacking.getPatientById(patId.trim());
        }
        %>
                        ...
                        <div class="entry">
                            <table border="0">
                                <tr>
                                    <td></td>
                                    <td colspan="7">
                                        <i><b><%= langBacking.getLiteral("unique_identifier") %></i></b>: <%= siteDoctorBacking.selectedPatientToViewHistory.id %>
                                    </td>
                                </tr>
                                <tr>
                                    <td width="135px">
                                        <%
                                        siteDoctorBacking.selectedPatientToViewHistory=siteDoctorBacking.getPatientPhotoInfo(siteDoctorBacking.selectedPatientToViewHistory);
                                        if(siteDoctorBacking.selectedPatientToViewHistory.getPhotoFileBytes()!=null && siteDoctorBacking.selectedPatientToViewHistory.getPhotoFileBytes().length>0)
                                        {
                                            out.println("<img src='data:image/jpg;base64,"+siteDoctorBacking.selectedPatientToViewHistory.getPhotoByteArrayString()+"' style='max-width:200px; max-height: 110px' />");
                                        }
                                        else
                                        {
                                    ...
                                    <td valign="top">
                                        <table border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <%= siteDoctorBacking.selectedPatientToViewHistory.name %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("surname") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.surname %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("fathers_name") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.fathersName %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("date_of_birth") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.getBirthDateStr(langBacking.getDateFormat()) %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("sex") %>:</td>
                                                <td>
                                                    <%= langBacking.getLiteral(siteDoctorBacking.selectedPatientToViewHistory.sex) %>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td valign="top">
                                        <table border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.getAddressStr() %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("home_phone") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.homephone %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("work_phone") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.workphone %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("mobile_phone") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.mobilephone %>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td valign="top">
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.getSsn() %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("insurance_name_type") %>:</td>
                                                <td>
                                                    <%= siteDoctorBacking.selectedPatientToViewHistory.insurancename %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td colspan="7">
                                        <b><i><%= langBacking.getLiteral("other_identifier") %></i></b>: <%= siteDoctorBacking.selectedPatientToViewHistory.otherIdentifier %>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="accordion" style="width:1000px">
                        <div>
                            ...
                            <div>
                                ...
                                <%
                                ArrayList<TeleAppointmentBean> patientTeleAppointmentsList = siteDoctorBacking.getAllTeleAppointmentsByPatientId(siteDoctorBacking.selectedPatientToViewHistory.id);
                                    ...
                                    <script id="scriptInit" type="text/javascript">
                                        ...
                                        <%
                                            for(int i=0; i<patientTeleAppointmentsList.size(); i++)
                                            {
                                                ...
                                                curTeleAppointment.setAdviceIcdList(siteDoctorBacking.findAdviceIcdListByAppId(curTeleAppointment.getId()));
                                                curTeleAppointment.setDiagnosisIcdList(siteDoctorBacking.findDiagnosisIcdListByAppId(curTeleAppointment.getId()));
                                                ...
                                                ArrayList<TeleAppointmentFileBean> allAppFiles = siteDoctorBacking.getTeleAppointmentFilesByAppointmentId(curTeleAppointment.getId());
                        ...
                        <div>
                            ...
                            <div>
                                <%
                                ArrayList<EmergencyCaseBean> patientEmergenciesList = siteDoctorBacking.getAllEmergenciesByPatientId(siteDoctorBacking.selectedPatientToViewHistory.id);
                            ...
                            <div>
                                ...
                                <script type="text/javascript">
                                    $("#patientFilesTable").wijgrid({
                                        ...
                                        data: [
                                        <%
                                        ArrayList<PatientFileBean> allPatientFilesResults = siteDoctorBacking.getAllPatientFilesResults();
                                        ...
                                        for(PatientFileBean curPatFileBean : allPatientFilesResults)
                                        {
                                            ...
                                            if(curPatFileBean.getAB().id.equals(siteDoctorBacking.AB.id))
                                            {
