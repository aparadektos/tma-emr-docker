                ...
                <div id="content">
                    ...
                    <div class="post">
                        <div class="entry">
                            ...
                            if(siteDoctorBacking.getSelectedTeleAppointment()!=null && siteDoctorBacking.getSelectedTeleAppointment().getId()!=null && siteDoctorBacking.getSelectedTeleAppointment().getId().length()>0)
                            {
                            %>
                            <form method="post" action="actions/add_diagnosis_action.jsp">
                                <input type="hidden" name="teleAppId" value="<%= siteDoctorBacking.getSelectedTeleAppointment().getId() %>"/>
                                <center>
                                    <textarea name="diagnosisText" cols="60" rows="15"><%= siteDoctorBacking.getSelectedTeleAppointment().getDiagnosis() %></textarea>
                                    <br/>
                                    <br/>
