...
(function ($) {
	...
	$.widget("wijmo.wijgrid", {
		...
		_render: function () {
			...
			if (o.allowPaging && ((o.pagerSettings.position === "top") || (o.pagerSettings.position === "topAndBottom"))) {
				if (!this.$topPagerDiv) {
			...
			if (o.allowPaging && ((o.pagerSettings.position === "bottom") || (o.pagerSettings.position === "topAndBottom"))) {
				if (!this.$bottomPagerDiv) {
