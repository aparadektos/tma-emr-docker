...
siteUserBacking.emergenciesSearchExamRoomId=examRoomId;
siteUserBacking.emergenciesSearchDateStr=erStartDateStr;

siteUserBacking.emergenciesSearchResults=new ArrayList<EmergencyCaseBean>(0);
...
if(examRoomId!=null && erStartDateStr!=null)
{
    ...
    siteUserBacking.emergenciesSearchResults=siteUserBacking.getAllEmergenciesBySearch(examRoomId, submittedDate);
}
else
{
//    Date today=new Date();
...
if(siteUserBacking.emergenciesSearchResults.size()==0)
{
    siteUserBacking.infoMessage=langBacking.getLiteral("no_emergencies_found");
}
