	...
	<div id="page">
		...
		<div id="content" >
                <%
                    ...
                    ArrayList<ExamroomsBean> examroomsBeans = siteUserBacking.getAllExamroomsBySiteId();
                    ...
                    if(patient!=null && patient.trim().length()>0 && patient.trim().equals("unknown"))
                    {
                        PB=new patBean("", "", "", "", "", "", "", "", "", "", "", "", "true");
                        //new emergency case
                        siteUserBacking.newEmergencyCaseBean=new EmergencyCaseBean();
                        siteUserBacking.newEmergencyCaseBean.patientBean=PB;
                        siteUserBacking.newEmergencyCaseBean.erRegForm=new EmergencyRegistrationFormBean();
                    ...
                    else
                    {
                        ...
                        {
                            PB = siteUserBacking.getPatientById(patId.trim());
                            //new emergency case
                            siteUserBacking.newEmergencyCaseBean=new EmergencyCaseBean();
                            siteUserBacking.newEmergencyCaseBean.patientBean=PB;
                            siteUserBacking.newEmergencyCaseBean.erRegForm=new EmergencyRegistrationFormBean();
                        }
                        else if(siteUserBacking.searchedPatientBean!=null)
                        {
                            PB=siteUserBacking.searchedPatientBean;
                            //new emergency case
                            siteUserBacking.newEmergencyCaseBean=new EmergencyCaseBean();
                            siteUserBacking.newEmergencyCaseBean.patientBean=PB;
                            siteUserBacking.newEmergencyCaseBean.erRegForm=new EmergencyRegistrationFormBean();
                    ...
                    if(siteUserBacking.newEmergencyCaseBean!=null && siteUserBacking.newEmergencyCaseBean.patientBean!=null)
                    {
                        PB=siteUserBacking.newEmergencyCaseBean.patientBean;
                %>
                        ...
                        <div class="post">
                            ...
                            <div class="entry">
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            erDateTime = DATE_FORMAT.format(siteUserBacking.newEmergencyCaseBean.caseDate);
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="erAge" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.erAge %>" style="width: 40px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                    ...
                                    <tr>
                                        <td>
                                            <select id="proselefsiSelect" name="erProselefsi">
                                                <%
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("alone")))
                                                {
                                                ...
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("accompanied")))
                                                {
                                                ...
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("ambulatory_transfer")))
                                                {
                                                ...
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("patient_transfer")))
                                                {
                                                ...
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("immobilization")))
                                                {
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="erOros" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.erOros %>" style="width: 290px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="erAllo" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.erAllo %>" style="width: 290px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                ...
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="histSymptom" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.histSymptom %>" style="width: 250px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <select id="smokerSelect" name="histSmoker">
                                                <%
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.histSmoker.equalsIgnoreCase(langBacking.getLiteral("yes")))
                                                {
                                                ...
                                                if(siteUserBacking.newEmergencyCaseBean.erRegForm.histSmoker.equalsIgnoreCase(langBacking.getLiteral("no")))
                                                {
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="histAlergic" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.histAlergic %>" style="width: 200px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="histLoimodi" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.histLoimodi %>" style="width: 200px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("accident")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("beating")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("car_accident")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("industrial_accident")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("fall")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("suicide_attempt")))
                                            {
                                ...
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="vitalTime" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.vitalTime %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalPulses" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.vitalPulses %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalAP" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.vitalAP %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalInhale" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.vitalInhale %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalSpo2" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.vitalSpo2 %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalT" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.vitalT %>" style="width: 50px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("cold")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("hot")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("dry")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("wet")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("sallow")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("cyan")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("jaundiced")))
                                            {
                                ...
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="erComments" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.erComments %>" style="width: 350px;"/> 
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td>
                                            <%
//                                            ArrayList<DoctorBean> siteDoctors = siteUserBacking.getAllDoctorsBySite();
...
//                                            out.println("</select>");
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("fever")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("shiver")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("cough")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("debilitation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hardship")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("nausea")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("dizziness")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("dry_mouth")))
                                            {
                                    ...
                                    <tr height="15px">
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("vommit")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("eructation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("disingestion")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("dyspepsia")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("feeling_fullness")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hematemesis")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("melaena")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("abdominal_pain")))
                                            {
                                    ...
                                    <tr height="15px">
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("diarrhea")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("constipation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("levitation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("ascites")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("rash")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("itch")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("edema")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("intoxication")))
                                            {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("poisoning")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hypertension")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("glycemia")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(siteUserBacking.optionIsContained(siteUserBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("Ηλεκ/κές")))
                                            {
                                        ...
                                        <td colspan="10">
                                            <input type="text" name="genOther" value="<%= siteUserBacking.newEmergencyCaseBean.erRegForm.genOther %>" style="width:250px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
