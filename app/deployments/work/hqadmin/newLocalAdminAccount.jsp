...
function changePasswordTextbox()
{
	...
	<div id="page">
		...
		<div id="content">
                    ...
                    %>
                    <div class="post">
                        <h2 class="title"><a href="#"><%= langBacking.getLiteral("add_account") %></a></h2>
                        <div class="entry">
                            <form id="addAccountForm" method="post" action="actions/add_siteadmin_account_action.jsp" enctype="multipart/form-data">
                                <table border="0">
                                    <tr>
                                        <td colspan="4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input disabled name="accPassword" id="passTextbox" value="" type="password" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            ...
                                            {
                                                if(curRole.roleName.equals("siteadmin"))
                                                {
                                                    out.println("<input type='hidden' name='accRoleId' value='"+curRole.roleID+"'/>");
                                                    out.println(langBacking.getLiteral(curRole.roleName));
                                                }
                                            }
                                            %>                                           
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="siteSelect" name="accSiteId">
                                                ...
                                                {
                                                    if(curSite.id.equals(hqAdminBacking.newAccountBean.SB.id))
                                                    {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="accEmail" value="<%= hqAdminBacking.newAccountBean.email %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("mobile_phone") %>:</td>
                                        <td>
                                            <input name="accMobilePhone" value="<%= hqAdminBacking.newAccountBean.mobilePhone %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("other_information") %>:</td>
                                        <td>
                                            <textarea name="accOtherInfo" id="area" rows="3" cols="40"><%= hqAdminBacking.newAccountBean.otherInfo %></textarea>
                                        </td>
                                    </tr>
                                    <tr>
