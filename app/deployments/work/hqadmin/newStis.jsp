...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="page">
		...
		<div id="content">
                    ...
                    %>
                    <div class="post">
                        <h2 class="title"><a href="#"><%= langBacking.getLiteral("add_stis") %></a></h2>
                        <div class="entry">
                            <form id="addStisForm" method="post" action="actions/add_stis_action.jsp">
                                <table border="0">
                                    <tr>
                                        <td align="right">
                                            <font color="red">
                                        ...
                                        <td>
                                            <input name="stisTitle" value="<%= hqAdminBacking.getNewStisBean().getTitle() %>" id="textbox" type="text" size="42" required/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="stisHospital" value="<%= hqAdminBacking.getNewStisBean().getNosokomeio() %>" id="textbox" type="text" size="42" required/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="stisIpAddress" value="<%= hqAdminBacking.getNewStisBean().getIpAddress() %>" id="textbox" type="text" size="42"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("comment") %>:</td>
                                        <td>
                                            <textarea name="stisComments" id="area" rows="3" cols="40"><%= hqAdminBacking.getNewStisBean().getComments() %></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="stisHospitalFullTitle" value="<%= hqAdminBacking.getNewStisBean().getNosokomeioFullTitle() %>" id="textbox" type="text" size="42" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="stisHospitalPhones" value="<%= hqAdminBacking.getNewStisBean().getNosokomeioPhones() %>" id="textbox" type="text" size="42" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="stisHospitalEmails" value="<%= hqAdminBacking.getNewStisBean().getNosokomeioEmails() %>" id="textbox" type="text" size="42" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("address") %>:</td>
                                        <td>
                                            <textarea name="stisHospitalAddress" id="area" rows="3" cols="40"><%= hqAdminBacking.getNewStisBean().getNosokomeioAddress() %></textarea>
                                        </td>
                                    </tr>    
                                    <tr>
