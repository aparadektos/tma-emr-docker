	...
	<div id="page">
		...
		<div id="content">
                    ...
                    <div class="post" id="newSiteFormDiv" >
                        <h2 class="title">
                            <a href="#"><%= langBacking.getLiteral("add_site") %></a></h2>
                        <div class="entry">
                            
                            <form id="addSiteForm" method="post" action="actions/add_site_action.jsp">
                                <table border="0">
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("name") %>:</td>
                                        <td>
                                            <input name="siteName" id="textbox" type="text" size="53"/>
                                        </td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea name="siteAddress" id="area" rows="2" cols="50"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("contact") %>:</td>
                                        <td>
                                            <textarea name="siteContact" id="area" rows="2" cols="50"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("site_print_title") %>:</td>
                                        <td>
                                            <textarea name="sitePrintTitle" id="area" rows="4" cols="50"></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                    <td align="center" colspan="2">
                                        <input type="button" value="<%= langBacking.getLiteral("save") %>" onClick="javascript:checkNewSiteForm();"/>
                                    </td>
                                    </tr>
                                </table>
                            </form>
