...
hqAdminBacking.newAccountBean.SB=new siteBean(accSiteId, "", "", "");
...
else
{
    ...
    if(accUsername!=null && accUsername.length()>0 && 
       accName!=null && accName.length()>0 && accSurname!=null && accSurname.length()>0 &&
       accRoleId!=null && accRoleId.length()>0)
    {
        ...
        if(passOk)
        {
            ...
            else
            {
                ...
                response.sendRedirect("../newLocalAdminAccount.jsp");
            }
        }
        else
        {
