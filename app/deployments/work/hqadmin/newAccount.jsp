	...
	<div id="page">
		...
		<div id="content">
                    ...
                    <div class="post">
                        ...
                        <div class="entry">
                            <form id="addAccountForm" method="post" action="actions/add_account_action.jsp" enctype="multipart/form-data">
                                <table border="0">
                                    <tr>
                                        <td colspan="4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="roleSelect" name="accRoleId">
                                                ...
                                                {
                                                    if(curRole.roleName.equals("hqadmin") || curRole.roleName.equals("manager") || 
                                                       curRole.roleName.equals("counterdesk") )
                                                    {
                                                        if(curRole.roleID.equals(hqAdminBacking.newAccountBean.RB.roleID))
                                                        {
                                    ...
                                    <input type='hidden' name='accSiteId' value='-1'/>
                                    <tr>
                                        <td align="right">
                                            <font color="red">
