...
function changePasswordTextbox()
{
	...
	<div id="page">
		...
		<div id="content">
                    ...
                    {
                        hqAdminBacking.accountToEdit=hqAdminBacking.getAccountById(accId);
                    }
                    %>
                    <div class="post">
                            ...
                            <form id="addAccountForm" method="post" action="actions/edit_account_action.jsp">
                                <table border="0">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%= hqAdminBacking.accountToEdit.username %>
                                        </td>
                                    </tr>
                                    <tr>
                                        <%
                                        String passFontColor="black";
                                        if(hqAdminBacking.accountToEdit.getByPassAd().equalsIgnoreCase("true"))
                                        {
                                            passFontColor="red";
                                        }
                                        %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="roleSelect" name="accRoleId">
                                                <%
                                                ArrayList<roleBean> allRoles=hqAdminBacking.getAllRoles();
                                                for(roleBean curRole : allRoles)
                                                {
                                                    if(curRole.roleName.equals("hqadmin") || curRole.roleName.equals("siteadmin") || 
                                                       curRole.roleName.equals("counterdesk") || curRole.roleName.equals("manager"))
                                                    {
                                                        if(curRole.roleID.equals(hqAdminBacking.accountToEdit.RB.roleID))
                                                        {
                                                            out.println("<option selected='true' value='"+curRole.roleID+"'>"+langBacking.getLiteral(curRole.roleName)+"</option>");
                                                        }
                                                        else
                                                        {
                                                            out.println("<option value='"+curRole.roleID+"'>"+langBacking.getLiteral(curRole.roleName)+"</option>");
                                                        }
                                                    }
                                                }
                                                %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="activeSelect" name="accActive">
                                                <%
                                                if(hqAdminBacking.accountToEdit.active.equalsIgnoreCase("yes"))
                                                {
                                                ...
                                                if(hqAdminBacking.accountToEdit.active.equalsIgnoreCase("no"))
                                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="accName" value="<%= hqAdminBacking.accountToEdit.name %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="accSurname" value="<%= hqAdminBacking.accountToEdit.surname %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("email") %>:</td>
                                        <td>
                                            <input name="accEmail" value="<%= hqAdminBacking.accountToEdit.email %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("mobile_phone") %>:</td>
                                        <td>
                                            <input name="accMobilePhone" value="<%= hqAdminBacking.accountToEdit.mobilePhone %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("other_information") %>:</td>
                                        <td>
                                            <textarea name="accOtherInfo" id="area" rows="3" cols="40"><%= hqAdminBacking.accountToEdit.otherInfo %></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="left">
