...
function changePasswordTextbox()
{
	...
	<div id="page">
		...
		<div id="content">
                    ...
                    {
                        hqAdminBacking.setSelectedSiteAdminAccountToEdit(hqAdminBacking.getAccountById(accId));
                    }
                    %>
                    <div class="post">
                        ...
                        <div class="entry">
                            <%
                            if(hqAdminBacking.getSelectedSiteAdminAccountToEdit()!=null)
                            {
                            %>
                            <form id="editAccountForm" method="post" action="actions/edit_siteadmin_account_action.jsp" enctype="multipart/form-data">
                                <table border="0">
                                    <tr>
                                        <td colspan="4">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%= hqAdminBacking.getSelectedSiteAdminAccountToEdit().username %>
                                        </td>
                                    </tr>
                                    <tr>
                                        <%
                                        String passFontColor="black";
                                        if(hqAdminBacking.getSelectedSiteAdminAccountToEdit().getByPassAd().equalsIgnoreCase("true"))
                                        {
                                            passFontColor="red";
                                        }
                                        %>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%= langBacking.getLiteral(hqAdminBacking.getSelectedSiteAdminAccountToEdit().RB.roleName) %>                                        
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                            <font color="red">
                                                <%= langBacking.getLiteral("site") %>:
                                            </font>
                                        </td>
                                        <td>
                                            <select id="siteSelect" name="accSiteId">
                                                <%
                                                ArrayList<siteBean> allSites=hqAdminBacking.getAllSites();
                                                for(siteBean curSite : allSites)
                                                {
                                                    if(curSite.id.equals(hqAdminBacking.getSelectedSiteAdminAccountToEdit().SB.id))
                                                    {
                                                        out.println("<option selected='true' value='"+curSite.id+"'>"+curSite.name+"</option>");
                                                    }
                                                    else
                                                    {
                                                        out.println("<option value='"+curSite.id+"'>"+curSite.name+"</option>");
                                                    }
                                                }
                                                %>
                                            </select>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <select id="activeSelect" name="accActive">
                                                <%
                                                if(hqAdminBacking.getSelectedSiteAdminAccountToEdit().active.equalsIgnoreCase("yes"))
                                                {
                                                ...
                                                if(hqAdminBacking.getSelectedSiteAdminAccountToEdit().active.equalsIgnoreCase("no"))
                                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="accName" value="<%= hqAdminBacking.getSelectedSiteAdminAccountToEdit().name %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="accSurname" value="<%= hqAdminBacking.getSelectedSiteAdminAccountToEdit().surname %>" id="textbox" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input name="accEmail" value="<%= hqAdminBacking.getSelectedSiteAdminAccountToEdit().email %>" type="email" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("mobile_phone") %>:</td>
                                        <td>
                                            <input name="accMobilePhone" value="<%= hqAdminBacking.getSelectedSiteAdminAccountToEdit().mobilePhone %>" type="text" size="25"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("other_information") %>:</td>
                                        <td>
                                            <textarea name="accOtherInfo" id="area" rows="3" cols="40"><%= hqAdminBacking.getSelectedSiteAdminAccountToEdit().otherInfo %></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="2">
                                            <input type="button" value="<%= langBacking.getLiteral("save") %>" onClick="javascript:checkEditAccountForm();"/>
                                        </td>
                                    </tr>
                                </table>
                            </form>
                            ...
                            {
                                out.println(langBacking.getLiteral("invalid_account_selected"));
                            }
                            %>
                        </div>
                    </div>
