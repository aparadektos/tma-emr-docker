<%-- 
    Document   : index
    Created on : 9 Μαϊ 2012, 10:34:39 πμ
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<hr><!-- end #logo -->
            <div id="header">
                <div id="menu">
                    <ul><li class="current_page_item"><a href="#" class="first">Home</a></li>
	...
	<div id="page">
		...
		<div id="content">
                    <div class="post">
                        <h2 class="title">
                            <a href="#">Welcome to OUR SITE</a>				</h2>
                        <div class="entry">
...
<p><a href="http://www.rickyswebtemplates.com/members/login.php">http://www.rickyswebtemplates.com/members/login.php</a>.</p>
    ...
    <div id="footer-bgcontent">
        <div id="footer">
            <p>Copyright  2011 YourSitename.com. All rights reserved. <!--%@##--> Design provided by <a href="http://www.freewebtemplates.com/">Free Website Templates</a>.<!--##@%--></p>
            <p>Find more free web templates at  <a href="http://www.rickyswebtemplates.com/" target="_blank">Free web templates</a>, <a href="http://www.webtemplates-download.com/" target="_blank">Free web layouts</a>, <a href="http://www.onlyfreewebtemplates.net/" target="_blank">Free css website templates</a></p>
        </div>
    </div>
	<!-- end #footer -->
    </div>
