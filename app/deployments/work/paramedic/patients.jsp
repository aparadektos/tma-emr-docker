...
function enlightDV(thisDV,examRoomID)
{
    ...
    document.getElementById("DivIDHidden").value=thisDV.id;
}
...
//function submitExamTypeSearchForm()
//{
//    document.getElementById("examTypeSearchForm").submit();
//}
...
{
    var submit=true;
    if(document.getElementById("searchPatientForm").patName.value!==null && 
       document.getElementById("searchPatientForm").patName.value.length!==0 && 
       document.getElementById("searchPatientForm").patName.value.length<3)
    {
        alert("<%= langBacking.getLiteral("search_min_length") %>");
        submit=false;
    }
    else if(document.getElementById("searchPatientForm").patSurname.value!==null && 
            document.getElementById("searchPatientForm").patSurname.value.length!==0 && 
       document.getElementById("searchPatientForm").patSurname.value.length<3)
    {
        alert("<%= langBacking.getLiteral("search_min_length") %>");
        submit=false;
    }
	...
	<div id="page">
		...
		<div id="content">
                    ...
                    else if(request.getParameter("action")!=null && request.getParameter("patid")!=null && request.getParameter("patid").length()>0 &&  request.getParameter("action").length()>0 && request.getParameter("action").equalsIgnoreCase("newAppoint"))
                    {
                        ...
                        if(newAppBean==null)
                        {
                            patBean PB=paramedicBacking.getPatientById(request.getParameter("patid"));
                            newAppBean=new appointmentsBean("", paramedicBacking.AB.SB.id, paramedicBacking.AB.id, PB.id, "", null, null, "", "", "", "", "", "");
                            newAppBean.PB=PB;
                        ...
                        {
                            allExamTypesList=paramedicBacking.getAllExamTypes();
                    ...
                    <div class="post" id="searchExamRoomsFormDiv">
                        ...
                        <div class="entry">
                            ...
                            %>
                                    ...
                                    <%
                                    if(paramedicBacking.selectedTimeslotDivId!=null && paramedicBacking.selectedTimeslotDivId.length()>0)
                                    {
                                    %>
                                        enlightDV( document.getElementById("<%= paramedicBacking.selectedTimeslotDivId %>"), <%= paramedicBacking.selectedExamRoomId %>);
                                    <%
                                    }
                                    %>
                            ...
                            <input type="hidden" id="DivIDHidden" name="DivIDHidden"/>
                            ...
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <textarea id="appComments" name="appComments" rows="2" cols="70"><%= newAppBean.comments %></textarea>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <%
                    if(newAppBean.ETB.getDescriptionEl().toUpperCase().indexOf("ΣΥΝΤΑΓΟΓΡΑΦ")<0)
                    {
                    %>
                    <div class="post" id="patientHistoryFormDiv">
                        ...
                        <table border="0" width="100%">
                            ...
                            <tr>
                                <td align="right">
                                    <%= langBacking.getLiteral("present_illness") %>
                                </td>
                                <td>
                                    <textarea name="patPresentIllness" id="area" rows="2" cols="60"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                    <%= langBacking.getLiteral("medication") %>
                                </td>
                                <td>
                                    <textarea name="patMedication" id="area" rows="2" cols="60"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                            ...
                            <tr>
                                <td align="right">
                                    <%= langBacking.getLiteral("past_diseases") %>
                                </td>
                                <td>
                                    <textarea name="patPastHistory" id="area" rows="2" cols="60"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td align="right">
                                    ICD-10
                                    <br/>
                                    <a name="icd10anchor" href="javascript: popupICD10SearchForm();"><img src="../images/kialia.png" width="40px"/></a>
                                </td>
                                <td>
                                    <table>
                                    <%
                                    for(Icd10Bean curIcd : newAppBean.icdList)
                                    {
                                        out.println("<tr>");
                                        out.println("<td>");
                                        out.println(curIcd.code);
                                        out.println("</td>");
                                        out.println("<td>");
                                        out.println("|&nbsp;&nbsp;"+curIcd.nameEl);
                                        out.println("</td>");
                                        out.println("</tr>");
                                    }
                                    %>
                            ...
                            <tr>
                                <td align="right">
                                    <%= langBacking.getLiteral("family_history") %>
                                </td>
                                <td>
                                    <textarea name="patFamilyHistory" id="area" rows="2" cols="60"></textarea>
                                </td>
                            </tr>
                        </table>
                    </div>
            ...
            else if(request.getParameter("action")!=null && request.getParameter("action").length()>0 && request.getParameter("action").equalsIgnoreCase("confirmApp"))
            {
                ...
                appointmentsBean newAppBean=paramedicBacking.newAppointment;
            %>
...
<!--                            <tr>
            ...
            %>
                ...
                if(paramedicBacking.patientSearchResults!=null && paramedicBacking.patientSearchResults.size()>0
                            && showResults==true)
                {
                    //search results
                %>
                <div class="post">
                    ...
                    <div class="entry">
                        ...
                        else if(paramedicBacking.patientSearchResults!=null && paramedicBacking.patientSearchResults.size()>0)
                        {
                            //we have results
                            //ArrayList<patBean> patList=(ArrayList<patBean>)session.getAttribute("patList");
                            
                            ArrayList<patBean> patList=paramedicBacking.patientSearchResults;
                            ...
                            <%
                                for(int i=0; i<patList.size(); i++)
                                {
                                    ...
                                    String otherInfo=langBacking.getLiteral("fathers_name")+": "+PB.fathersName+"<br/>";
                                    otherInfo+=langBacking.getLiteral("sex")+": "+langBacking.getLiteral(PB.sex)+"<br/>";
                                    if(langBacking.lang.equalsIgnoreCase("greek"))
                                    {
                                        otherInfo+=langBacking.getLiteral("nationality")+": "+langBacking.getLiteral(PB.getCountryBean().getNationalityEl());
                                    }
                                    else
                                    {
                                        otherInfo+=langBacking.getLiteral("nationality")+": "+langBacking.getLiteral(PB.getCountryBean().getNationalityEn());
                                    }
                                    
                                    if(i<patList.size()-1)
                                    {
                                        out.println("['"+PB.name+"<br/>"+PB.surname+"<br/>("+PB.getBirthDateStr(langBacking.getDateFormat())+")', '"+otherInfo+"', '"+PB.getMobilephone()+"<br/>"+PB.getHomephone()+"<br/>"+PB.getAddressStr()+"','"+PB.getInsurancename()+"<br/>"+PB.getSsn()+"','<a href=\"viewPatientHistory.jsp?patId="+PB.id+"\"><img title=\""+langBacking.getLiteral("view_patient_record")+"\" src=\"../images/openFile.png\" width=\"32px\"/></a>&nbsp;&nbsp;&nbsp;<a href=\"editPatient.jsp?patId="+PB.id+"\"><img title=\""+langBacking.getLiteral("edit_patient")+"\" src=\"../images/edit2.png\" width=\"32px\"/></a>&nbsp;&nbsp;<a href=\"newTeleAppointment.jsp?patid="+PB.id+"\"><img title=\""+langBacking.getLiteral("new_tele_appointment")+"\" width=\"32px\" src=\"../images/addTeleAppoint.png\"/></a>&nbsp;&nbsp;&nbsp;<a href=\"emergency.jsp?patid="+PB.id+"\"><img title=\""+langBacking.getLiteral("new_emergency_case")+"\" width=\"32px\" src=\"../images/emergencies.png\"/></a>' ],");
                                    }
                                    else
                                    {
                                        out.println("['"+PB.name+"<br/>"+PB.surname+"<br/>("+PB.getBirthDateStr(langBacking.getDateFormat())+")', '"+otherInfo+"', '"+PB.getMobilephone()+"<br/>"+PB.getHomephone()+"<br/>"+PB.getAddressStr()+"','"+PB.getInsurancename()+"<br/>"+PB.getSsn()+"','<a href=\"viewPatientHistory.jsp?patId="+PB.id+"\"><img title=\""+langBacking.getLiteral("view_patient_record")+"\" src=\"../images/openFile.png\" width=\"32px\"/></a>&nbsp;&nbsp;&nbsp;<a href=\"editPatient.jsp?patId="+PB.id+"\"><img title=\""+langBacking.getLiteral("edit_patient")+"\" src=\"../images/edit2.png\" width=\"32px\"/></a>&nbsp;&nbsp;<a href=\"newTeleAppointment.jsp?patid="+PB.id+"\"><img title=\""+langBacking.getLiteral("new_tele_appointment")+"\" width=\"32px\" src=\"../images/addTeleAppoint.png\"/></a>&nbsp;&nbsp;&nbsp;<a href=\"emergency.jsp?patid="+PB.id+"\"><img title=\""+langBacking.getLiteral("new_emergency_case")+"\" width=\"32px\" src=\"../images/emergencies.png\"/></a>' ],");
...
//                        if(paramedicBacking.searchedPatientBean!=null)
//                        {
//                            out.println("<br/><br/>");
