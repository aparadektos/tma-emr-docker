		...
		<div id="content">
                    ...
                    <div class="post">
                        ...
                        <div class="entry">
                            ...
                            if(paramedicBacking.getTeleAppointmentIdToConfirm()!=null && paramedicBacking.getTeleAppointmentIdToConfirm().length()>0)
                            {
                                savedTeleAppointment=paramedicBacking.getTeleAppointmentById(paramedicBacking.getTeleAppointmentIdToConfirm());
                            %>
                            <table>
                                <tr>
                                    <td align="right">
