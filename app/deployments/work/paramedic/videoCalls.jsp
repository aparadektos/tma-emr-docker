...
function refreshReqDate()
{
	...
	<div id="page">
		...
		<div id="content" style="width:100%">
                    ...
                    <%
                    if(paramedicBacking!=null && paramedicBacking.getErrorMessage().length()>0)
                    {
                        ...
                        out.println(paramedicBacking.getErrorMessage());
                        out.println("</td></tr></table>");
                        out.println("</div>");
                    }
                    else if(paramedicBacking!=null && paramedicBacking.getOkMessage().length()>0)
                    {
                        out.println("<div class='post'>");
                        out.println("<table border=0 style='border: 1px solid grey; width:1000px;'><tr><td valign='middle' width='70px'>");
                        out.println("<img src='../images/check.png' width='64px'/>");
                        out.println("</td><td valign='middle'>");
                        out.println(paramedicBacking.getOkMessage());
                        out.println("</td></tr></table>");
                        out.println("</div>");
                    }
                    else if(paramedicBacking!=null && paramedicBacking.getInfoMessage().length()>0)
                    {
                        out.println("<div class='post'>");
                        out.println("<table border=0 style='border: 1px solid grey; width:1000px;'><tr><td valign='middle' width='70px'>");
                        out.println("<img src='../images/info.png' width='64px'/>");
                        out.println("</td><td valign='middle'>");
                        out.println(paramedicBacking.getInfoMessage());
                        out.println("</td></tr></table>");
                        out.println("</div>");
                    }
                        ...
                        <tr>
                            <td width="50%" valign="top">
                                <div id="medicTabs">
                                    ...
                                    <div id="medicTab1">
                                        <center>
                                            <iframe width="550" height="500" src="https://primemarine.tma.com.gr:2443/consultantOneWayMinfied.html?<%= medicalCallee+"&"+medicalCaller %>&" allow='microphone; camera'></iframe>
                                        </center>
                                    </div>
                                </div>
                            </td>
                            <td width="50%" valign="top">
                                <div id="confTabs">
                                    ...
                                    <div id="confTab1">
                                        <center>
                                            <iframe width="550" height="500" src="https://primemarine.tma.com.gr:2443/consultantMinfied.html?<%= confCallee+"&"+confCaller %>&" allow='microphone; camera'></iframe>
                                        </center>
                                    </div>
                                </div>
                            </td>
