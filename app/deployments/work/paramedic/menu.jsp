...
//            {
//                out.println("<li class='current_page_item'><a href='appointments.jsp' class='first'>"+langBacking.getLiteral("appointments")+"</a></li>");
//            }
//            else
//            {
//                out.println("<li><a href='appointments.jsp'>"+langBacking.getLiteral("appointments")+"</a></li>");
//            }
            %>
            ...
            <%
//            if(request.getAttribute("target")!=null && request.getAttribute("target").equals("teleEmergency"))
//            {
//                out.println("<li class='current_page_item'><a href='teleEmergency.jsp'>"+ langBacking.getLiteral("emergencies") +"</a></li>");
//            }
//            else
//            {
//                out.println("<li><a href='teleEmergency.jsp'>"+ langBacking.getLiteral("emergencies") +"</a></li>");
//            }
            %>
