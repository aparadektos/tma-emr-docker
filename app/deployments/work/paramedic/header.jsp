...
<div id="logo">
    <table border="0" width="100%">
        <tr>
            ...
            <td width="100%">
                <font color="white">
                    <b><%= langBacking.getLiteral("user") %>:</b> <%= AB.getParamedicBean().getFullName() %> 
                    <br/> 
                    <b><%= langBacking.getLiteral("role") %>:</b> <%= langBacking.getLiteral(AB.RB.roleName) %>
                    <br/>
                    <b><%= langBacking.getLiteral("stia") %>:</b> <%= AB.SB.name %>
                    <br/>
                    <b><%= langBacking.getLiteral("flag") %>:</b> <%= AB.SB.getFlagBean().getNameByLang(langBacking.lang) %>
                    <br/>
                    <b><%= langBacking.getLiteral("specialty") %></b>: <%= AB.getParamedicBean().getParamTypeBean().getNameByLang(langBacking.lang) %>
                </font>
            </td>
