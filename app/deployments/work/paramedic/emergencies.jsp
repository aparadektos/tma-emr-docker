...
<!--        <link href="../wijmotools/wijmo/jquery.wijmo.wijcombobox.css" rel="stylesheet" type="text/css" />-->
	...
	<div id="page">
		...
		<div id="content" style="width:100%">
                                ...
                                <table border="0">
                                   ...
                                   <tr>        
                                       <td>
                                           ...
                                           <%
                                           if(paramedicBacking.emergenciesSearchExamRoomId==null)
                                           {
                                           ...
                                           {
                                               if(exRoom.id.equalsIgnoreCase(paramedicBacking.emergenciesSearchExamRoomId))
                                               {
                    ...
                    <%
                    ArrayList<EmergencyCaseBean> emergenciesList=paramedicBacking.emergenciesSearchResults;
...
<!--                        <h2 class="title"><a href="#">Appointments Table</a></h2>-->
                            ...
                            %>
                                ...
                                <%
                                    ...
                                    for(int i=0; i<emergenciesList.size(); i++)
                                    {
                                        ...
                                        String actionsHref="";
                                        String teleAdvice="";
                                        TeleAppointmentBean teleAppBean = paramedicBacking.getTeleAppointmentByEmergencyCaseId(curER.id);
    ...
    <script type="text/javascript">
        ...
        $("#erStartDatePicker").wijinputdate({
            ...
            %>
        <%
        if(paramedicBacking.emergenciesSearchDateStr!=null && paramedicBacking.emergenciesSearchDateStr.length()>0)
        {
            out.println("date: '"+paramedicBacking.emergenciesSearchDateStr+"',");
        }
        %>
        //date: '12/8/2012',
