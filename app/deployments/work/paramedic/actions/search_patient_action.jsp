...
{
    //create new patBean
    patBean PB=new patBean("", patName, patSurname, patFathersName, "", patHomePhone, "", patMobilePhone, patSSN, "", paramedicBacking.AB.SB.id, "", "");
    PB.birthDate=birthDate;
    
    
    paramedicBacking.searchPatientBySite(PB);
    ...
    {
        paramedicBacking.infoMessage=langBacking.getLiteral("search_no_patients");
        response.sendRedirect("../patients.jsp");
    }
}
else
{
    ...
    paramedicBacking.patientSearchResults=null;
