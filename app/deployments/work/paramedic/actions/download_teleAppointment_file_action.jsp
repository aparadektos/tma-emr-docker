...
{
    TeleAppointmentFileBean selectedFile = paramedicBacking.getTeleAppointmentFileById(fileId);
    if(selectedFile!=null)
    {
        byte[] fileByteArray = paramedicBacking.downloadTeleAppointmentFile(fileId);
