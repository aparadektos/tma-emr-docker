...
<script language="javascript">
    ...
    function calcScore()
    {
        var totalScore=0;
        //open eyes
        if(document.getElementById("emergencyForm").neuroSergOpenEyesAuthormita.checked===true)
        {
            totalScore+=4;
        }
        if(document.getElementById("emergencyForm").neuroSergProforikoAlgos.checked===true)
        {
            totalScore+=3;
        }
        if(document.getElementById("emergencyForm").neuroSergAlgos.checked===true)
        {
            totalScore+=2;
        }
        if(document.getElementById("emergencyForm").neuroSergOpenEyesOuden.checked===true)
        {
            totalScore+=1;
        }
        
        //oral answer
        if(document.getElementById("emergencyForm").neuroSergProsanatolismeni.checked===true)
        {
            totalScore+=5;
        }
        if(document.getElementById("emergencyForm").neuroSergSygxitiki.checked===true)
        {
            totalScore+=4;
        }
        if(document.getElementById("emergencyForm").neuroSergWords.checked===true)
        {
            totalScore+=3;
        }
        if(document.getElementById("emergencyForm").neuroSergSounds.checked===true)
        {
            totalScore+=2;
        }
        if(document.getElementById("emergencyForm").neuroSergOralOuden.checked===true)
        {
            totalScore+=1;
        }
        
        //best kinetic answer
        if(document.getElementById("emergencyForm").neuroSergYpakoi.checked===true)
        {
            totalScore+=6;
        }
        if(document.getElementById("emergencyForm").neuroSergEntyposiAlgous.checked===true)
        {
            totalScore+=5;
        }
        if(document.getElementById("emergencyForm").neuroSergCineticAfthormita.checked===true)
        {
            totalScore+=4;
        }
        if(document.getElementById("emergencyForm").neuroSergKampsiAlgos.checked===true)
        {
            totalScore+=3;
        }
        if(document.getElementById("emergencyForm").neuroSergEktasiAlgos.checked===true)
        {
            totalScore+=2;
        }
        if(document.getElementById("emergencyForm").neuroSergCineticOuden.checked===true)
        {
            totalScore+=1;
        }
        
        document.getElementById("neuroSergSynoloVathmwn").value=totalScore+" (GCS: "+getKekInfo(totalScore)+")";
    }
    function getKekInfo(score)
    {
        if(score>=14 && score<=15)
        {
            return "<%= langBacking.getLiteral("light_kek") %>";
        }
        else if(score>=9 && score<=13)
        {
            return "<%= langBacking.getLiteral("medium_kek") %>";
        }
        else if(score>=3 && score<=8)
        {
            return "<%= langBacking.getLiteral("heavy_kek") %>";
        }
        else
        {
            return "";
	...
	<div id="page">
		...
		<div id="content" >
                <%
                    ...
                    ArrayList<ExamroomsBean> examroomsBeans = paramedicBacking.getAllExamroomsBySiteId();
                    ...
                    if(patient!=null && patient.trim().length()>0 && patient.trim().equals("unknown"))
                    {
                        PB=new patBean("", "", "", "", "", "", "", "", "", "", "", "", "true");
                        //new emergency case
                        paramedicBacking.newEmergencyCaseBean=new EmergencyCaseBean();
                        paramedicBacking.newEmergencyCaseBean.patientBean=PB;
                        paramedicBacking.newEmergencyCaseBean.erRegForm=new EmergencyRegistrationFormBean();
                        paramedicBacking.searchedPatientBean=null;
                    }
                    else
                    {
                        ...
                        else if(paramedicBacking.searchedPatientBean!=null)
                        {
                            PB=paramedicBacking.searchedPatientBean;
                            //new emergency case
                            paramedicBacking.newEmergencyCaseBean=new EmergencyCaseBean();
                            paramedicBacking.newEmergencyCaseBean.patientBean=PB;
                            paramedicBacking.newEmergencyCaseBean.erRegForm=new EmergencyRegistrationFormBean();
                    ...
                    if(paramedicBacking.newEmergencyCaseBean!=null && paramedicBacking.newEmergencyCaseBean.patientBean!=null)
                    {
                        PB=paramedicBacking.newEmergencyCaseBean.patientBean;
                %>
                    <form name="emergencyForm" id="emergencyForm" method="post" action="actions/add_emergency_action.jsp">
                        ...
                        <div class="post" >
                            <h2 class="title"><a href="#"><%= langBacking.getLiteral("exam_room_selection") %></a></h2>
                            <div class="entry">
                        ...
                        <div class="post">
                            ...
                            <div class="entry">
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            erDateTime = DATE_FORMAT.format(paramedicBacking.newEmergencyCaseBean.caseDate);
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="erAge" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.erAge %>" style="width: 40px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                    ...
                                    <tr>
                                        <td>
                                            <select id="proselefsiSelect" name="erProselefsi">
                                                <%
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("alone")))
                                                {
                                                ...
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("accompanied")))
                                                {
                                                ...
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("ambulatory_transfer")))
                                                {
                                                ...
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("patient_transfer")))
                                                {
                                                ...
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.erProselefsi.equalsIgnoreCase(langBacking.getLiteral("immobilization")))
                                                {
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="erOros" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.erOros %>" style="width: 290px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="erAllo" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.erAllo %>" style="width: 290px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                ...
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="histSymptom" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.histSymptom %>" style="width: 250px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <select id="smokerSelect" name="histSmoker">
                                                <%
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.histSmoker.equalsIgnoreCase(langBacking.getLiteral("yes")))
                                                {
                                                ...
                                                if(paramedicBacking.newEmergencyCaseBean.erRegForm.histSmoker.equalsIgnoreCase(langBacking.getLiteral("no")))
                                                {
                                        ...
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="histAlergic" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.histAlergic %>" style="width: 200px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="histLoimodi" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.histLoimodi %>" style="width: 200px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("accident")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("beating")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("car_accident")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("industrial_accident")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("fall")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.trauma,langBacking.getLiteral("suicide_attempt")))
                                            {
                                ...
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="vitalTime" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.vitalTime %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalPulses" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.vitalPulses %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalAP" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.vitalAP %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalInhale" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.vitalInhale %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalSpo2" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.vitalSpo2 %>" style="width: 50px;"/>
                                        </td>
                                        <td>&nbsp;</td>
                                        <td>
                                            <input type="text" name="vitalT" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.vitalT %>" style="width: 50px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                ...
                                <table border="0">
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("cold")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("hot")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("dry")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("wet")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("sallow")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("cyan")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.derma,langBacking.getLiteral("jaundiced")))
                                            {
                                ...
                                <table border="0">
                                    ...
                                    <tr>
                                        <td>
                                            <input type="text" name="erComments" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.erComments %>" style="width: 350px;"/> 
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td>
                                            <%
//                                            ArrayList<DoctorBean> siteDoctors = paramedicBacking.getAllDoctorsBySite();
...
//                                            out.println("</select>");
                                ...
                                <table border="0"><!-- ALLAGMENOS -->
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("fever")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("shiver")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("cough")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("debilitation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hardship")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("nausea")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("dizziness")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("dry_mouth")))
                                            {
                                    ...
                                    <tr height="15px">
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("vommit")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("eructation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("disingestion")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("dyspepsia")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("feeling_fullness")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hematemesis")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("melaena")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("abdominal_pain")))
                                            {
                                    ...
                                    <tr height="15px">
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("diarrhea")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("constipation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("levitation")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("ascites")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("rash")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("itch")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("edema")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("intoxication")))
                                            {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("poisoning")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hypertension")))
                                            {
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("glycemia")))
                                            {
                                        ...
                                        <td>&nbsp;&nbsp;</td>
                                        <td align="right">
                                            <%= langBacking.getLiteral("hkf_diataraxes") %>
                                        </td>
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.genikiSimeiologia,langBacking.getLiteral("hkf_diataraxes")))
                                            {
                                        ...
                                        <td colspan="10">
                                            <input type="text" name="genOther" value="<%= paramedicBacking.newEmergencyCaseBean.erRegForm.genOther %>" style="width:250px;"/>
                                        </td>
                                    </tr>
                                </table>
                                <br/>
                                <b><%= langBacking.getLiteral("surgical_semiology") %></b>
                                <table border="0"> <!-- ALLAGMENOS PINAKAS -->
                                    <tr>
...
<!--                                <br/>
                                ...
                                <table border="0" width="900px"><!-- ALLAGMENOS PINAKAS -->
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergAnoiktoiOfthalmoi,langBacking.getLiteral("spontaneously")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergOpenEyesAuthormita' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergOpenEyesAuthormita'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergAnoiktoiOfthalmoi,langBacking.getLiteral("oral_pain")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergProforikoAlgos' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergProforikoAlgos'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td align="right">
                                            <%= langBacking.getLiteral("ston_pono") %> 
                                        </td>
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergAnoiktoiOfthalmoi,langBacking.getLiteral("ston_pono")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergAlgos' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergAlgos'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergAnoiktoiOfthalmoi,langBacking.getLiteral("none")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergOpenEyesOuden' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergOpenEyesOuden'/>");
                                            }
                                            %>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriProforikiApantisi,langBacking.getLiteral("directed")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergProsanatolismeni' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergProsanatolismeni'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriProforikiApantisi,langBacking.getLiteral("confounding")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergSygxitiki' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergSygxitiki'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriProforikiApantisi,langBacking.getLiteral("incongruous_words")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergWords' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergWords'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriProforikiApantisi,langBacking.getLiteral("aloof_sounds")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergSounds' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergSounds'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td align="right">
                                            <%= langBacking.getLiteral("kamia") %>  
                                        </td>
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriProforikiApantisi,langBacking.getLiteral("kamia")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergOralOuden' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergOralOuden'/>");
                                            }
                                            %>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriKinitikiApantisi,langBacking.getLiteral("obedience_to_order")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergYpakoi' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergYpakoi'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriKinitikiApantisi,langBacking.getLiteral("impression_of_pain")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergEntyposiAlgous' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergEntyposiAlgous'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td align="right">
                                            <%= langBacking.getLiteral("normal_kampsi") %>
                                        </td>
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriKinitikiApantisi,langBacking.getLiteral("normal_kampsi")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergCineticAfthormita' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergCineticAfthormita'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriKinitikiApantisi,langBacking.getLiteral("bending_in_pain")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergKampsiAlgos' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergKampsiAlgos'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        ...
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriKinitikiApantisi,langBacking.getLiteral("extend_in_pain")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergEktasiAlgos' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergEktasiAlgos'/>");
                                            }
                                            %>
                                        </td>
                                        <td>&nbsp;&nbsp;</td>
                                        <td align="right">
                                            <%= langBacking.getLiteral("cinetic_none") %>
                                        </td>
                                        <td>
                                            <%
                                            if(paramedicBacking.optionIsContained(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergKalyteriKinitikiApantisi,langBacking.getLiteral("cinetic_none")))
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergCineticOuden' checked='true'/>");
                                            }
                                            else
                                            {
                                                out.println("<input onchange='javascript:calcScore();' type='checkbox' name='neuroSergCineticOuden'/>");
                                            }
                                            %>
                                        </td>
                                    </tr>    
                                </table>
                                <table border="0" width="900px"><!-- ALLAGMENOS -->
                                    <tr>
                                        <td align="right">
                                ...
                                <table border="0"><!-- ALLAGMENOS PINAKAS -->
                                    <tr>
                                        ...
                                        <td align="left" colspan="5">
                                            <%
                                            if(paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergSynoloVathmwn!=null && 
                                               paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergSynoloVathmwn.length()>0)
                                            {
                                                out.println("<input type='text' value='"+paramedicBacking.newEmergencyCaseBean.erRegForm.neuroSergSynoloVathmwn+"' name='neuroSergSynoloVathmwn' id='neuroSergSynoloVathmwn' style='width: 170px;'/>");
                                                out.println("<script type='text/javascript'>calcScore();</script>");
                                            }
                                            else
                                            {
                                                out.println("<input type='text' name='neuroSergSynoloVathmwn' id='neuroSergSynoloVathmwn' style='width: 300px;'/>");
                                            }
                                            %>
                                        </td>
                                    </tr>
