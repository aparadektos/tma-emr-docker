...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<div id="page">
		...
		<div id="content">
                    ...
                    if(patId!=null)
                    {
                        patBean PB=paramedicBacking.getPatientById(patId);
                        paramedicBacking.setNewTeleappointment(new TeleAppointmentBean());
                        paramedicBacking.getNewTeleappointment().setPatientBean(PB);
                    }
                    ...
                    if(reqDateStr!=null)
                    {
                        ...
                        paramedicBacking.getNewTeleappointment().setStartdatetime(new Timestamp(sdf.parse(reqDateStr).getTime()));
                    }
                    else if(paramedicBacking.getNewTeleappointment().getStartdatetime()==null)
                    {
                        paramedicBacking.getNewTeleappointment().setStartdatetime(new Timestamp(new Date().getTime()));
                    }
                    %>
                    <div class="post">
                                    ...
                                    <td>
                                        <table border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                     <%= paramedicBacking.getNewTeleappointment().getPatientBean().name %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("surname") %>:</td>
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().surname %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("date_of_birth") %>:</td>
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().getBirthDateStr(langBacking.getDateFormat()) %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("sex") %>:</td>
                                                <td>
                                                    <%= langBacking.getLiteral(paramedicBacking.getNewTeleappointment().getPatientBean().sex.toLowerCase()) %>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table border="0">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().getAddressStr() %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("home_phone") %>:</td>
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().homephone %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("work_phone") %>:</td>
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().workphone %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("mobile_phone") %>:</td>
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().mobilephone %>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().getSsn() %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td align="right"><%= langBacking.getLiteral("insurance_name_type") %>:</td>
                                                <td>
                                                    <%= paramedicBacking.getNewTeleappointment().getPatientBean().insurancename %>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>&nbsp;</td>
                        ...
                        <form method="post" action="actions/search_available_efimeries_action.jsp">
                            <table border="0">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <%
                                        ArrayList<SpecialtyBean> allSpecialties = paramedicBacking.getAllSpecialties(langBacking.lang);
                                        out.println("<select id='specialtySelectId1' name='consultantSpecialtyId1'>");
                                        for(SpecialtyBean curSpec : allSpecialties)
                                        {
                                            if(curSpec.id.equals(paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean1().getId()))
                                            {
                                    ...
                                    <td>
                                        ...
                                        for(SpecialtyBean curSpec : allSpecialties)
                                        {
                                            if(paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean2()!=null && curSpec.id.equals(paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean2().getId()))
                                            {
                                                out.println("<option selected value='"+curSpec.id+"'>"+curSpec.getNameByLang(langBacking.lang)+"</option>");
                                            }
                                            else
                    ...
                    {
                        for(EfimeriaBean curEfimeria : paramedicBacking.getAvailableEfimeriesResults())
                        {
                            if(curEfimeria.getId().equals(selectedEfimeriaId1))
                            {
                                selectedEfimeriaBean1=curEfimeria;
                                paramedicBacking.getNewTeleappointment().setStisBean1(selectedEfimeriaBean1.getStisBean());
                                paramedicBacking.getNewTeleappointment().setConsultantBean1(selectedEfimeriaBean1.getConsultantBean());
                                break;
                            }
                        }
                        ...
                        try
                        {
                            ...
                            selectedDateTime = sdf.parse(paramedicBacking.getNewTeleappointment().getStartDateStr(langBacking.getDateFormat())+" "+selectedTime1);
                       ...
                       selectedEfimeriaId1!=selectedEfimeriaId2 && selectedTime1.equals(selectedTime2))
                    {
                        for(EfimeriaBean curEfimeria : paramedicBacking.getAvailableEfimeriesResults())
                        {
                            if(curEfimeria.getId().equals(selectedEfimeriaId2))
                            {
                                ...
                                paramedicBacking.getNewTeleappointment().setStisBean2(selectedEfimeriaBean2.getStisBean());
                                paramedicBacking.getNewTeleappointment().setConsultantBean2(selectedEfimeriaBean2.getConsultantBean());
                                break;
                            }
                        }
                    }
                    
                    if(paramedicBacking.getNewTeleappointment().getStisBean1()!=null && 
                       paramedicBacking.getNewTeleappointment().getStisBean1().getId()!=null && 
                       paramedicBacking.getNewTeleappointment().getStisBean1().getId().length()>0 && 
                       paramedicBacking.getNewTeleappointment().getConsultantBean1()!=null && 
                       paramedicBacking.getNewTeleappointment().getConsultantBean1().getId()!=null && 
                       paramedicBacking.getNewTeleappointment().getConsultantBean1().getId().length()>0 && 
                       paramedicBacking.getNewTeleappointment().getStartdatetime() != null)
                    {
                                ...
                                <table border="0">
                                    <tr>
                                        <td>
                                            <table>
                                                <tr>
                                                    ...
                                                    <td align="left">
                                                        <%= paramedicBacking.getNewTeleappointment().getStisBean1().getTitle()+" ("+paramedicBacking.getNewTeleappointment().getStisBean1().getNosokomeio()+")" %>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td align="left">
                                                        <%= paramedicBacking.getNewTeleappointment().getConsultantBean1().getSpecialtyBean().getNameByLang(langBacking.lang) %>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td align="left">
                                                        <a href="javascript:popupShowConsultant('<%= paramedicBacking.getNewTeleappointment().getConsultantBean1().getId() %>')"><%= paramedicBacking.getNewTeleappointment().getConsultantBean1().getFullName() %></a>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td align="right">
                                                    ...
                                                    <td align="left">
                                                        <%= paramedicBacking.getNewTeleappointment().getStartDateTimeStr(langBacking.getDateFormat()) %>
                                                    </td>
                                                </tr>
                                            </table>
                                        </td>
                                        <td align="center" width="100px">
                                            <%
                                            if(paramedicBacking.getNewTeleappointment().getStisBean2()!=null && 
                                               paramedicBacking.getNewTeleappointment().getConsultantBean2()!=null)
                                            {
                                            ...
                                            %>
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td align="left">
                                                            <%= paramedicBacking.getNewTeleappointment().getStisBean2().getTitle()+" ("+paramedicBacking.getNewTeleappointment().getStisBean2().getNosokomeio()+")" %>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <%= paramedicBacking.getNewTeleappointment().getConsultantBean2().getSpecialtyBean().getNameByLang(langBacking.lang) %>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                                                        ...
                                                        <td align="left">
                                                            <a href="javascript:popupShowConsultant('<%= paramedicBacking.getNewTeleappointment().getConsultantBean2().getId() %>')"><%= paramedicBacking.getNewTeleappointment().getConsultantBean2().getFullName() %></a>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align="right">
                        ...
                        <div class="post">
                            ...
                            <div class="entry">
                                <form method="post" action="actions/upload_teleAppointment_file_action.jsp" enctype="multipart/form-data">
                                    ...
                                    <table border="0">
                                        <%
                                        for(FileItem curFile : paramedicBacking.getNewTeleappointment().getFileItems())
                                        {
                                            out.println("<tr>");
...
//                                    out.println("<br/>");
                    ...
                    else if(paramedicBacking.isShowAvailableEfimeriesResults()==true &&
                            paramedicBacking.getAvailableEfimeriesResults()!=null && 
                            paramedicBacking.getAvailableEfimeriesResults().size()>0)
                    {
                    %>
                    <div class="post">
                        ...
                        <div class="entry">
                            ...
                            $(document).ready(function () {
                                ...
                                if(paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean2()!=null)
                                {
                                    paramedicBacking.getAllTeleAppointmentsBySpecialtiesIdsAndDate(paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean1().getId(),paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean2().getId(),paramedicBacking.getNewTeleappointment().getStartdatetime());
                                }
                                else
                                {
                                    paramedicBacking.getAllTeleAppointmentsBySpecialtiesIdsAndDate(paramedicBacking.getNewTeleappointment().getRequestedSpecialtyBean1().getId(),"",paramedicBacking.getNewTeleappointment().getStartdatetime());
                                }

                                Calendar reqDateCal = Calendar.getInstance();
                                reqDateCal.setTime(paramedicBacking.getNewTeleappointment().getStartdatetime());
                                ...
                                while(true)
                                {
                                    ...
                                    {
//                                        ypotithetai oti ayta sto EDIT ta kratousame gia kavantza gia tin metafora rantebou an eskage ektakto
...
//                                        }
                                        ...
                                        EfimeriaBean retrievedEfimeria = paramedicBacking.findEfimeriaByStisAndDate(curStis.getId(),reqDateCal.getTime());
                    ...
                    <%
                        paramedicBacking.setShowAvailableEfimeriesResults(false);
                    }
                    %>
                </div>
...
date: '<%= paramedicBacking.getNewTeleappointment().getStartDateStr(langBacking.getDateFormat()) %>',
//date: '12/8/2012',
//dateFormat: 'dddd',
showTrigger: true
});
