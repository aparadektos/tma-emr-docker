...
<script language="javascript">
	...
	<div id="page">
		...
		<div id="content" style="width:100%">
                    ...
                    {
                        counterdeskBacking.setSelectedWebinarBeanToEdit(counterdeskBacking.getWebinarFromResultsById(webinarId));
                    }
                    ...
                    <div class="post">
                        ...
                        <div class="entry">
                            <%
                            if(counterdeskBacking.getSelectedWebinarBeanToEdit()!=null)
                            {
                            %>
                            <form method="post" action="actions/edit_webinar_action.jsp">
                                <table border="0" width="100%">
                                    <tr>
                                        ...
                                        <td colspan="10" align="left">
                                            <select name="webinarType" id="webinarTypeSelect">
                                                <%
                                                if(counterdeskBacking.getSelectedWebinarBeanToEdit().getType().equalsIgnoreCase("Τηλε-διάσκεψη"))
                                                {
                                                    out.println("<option selected value='Τηλε-διάσκεψη'>Τηλε-διάσκεψη</option>");
                                                }
                                                else
                                                {
                                                    out.println("<option value='Τηλε-διάσκεψη'>Τηλε-διάσκεψη</option>");
                                                }
                                                
                                                if(counterdeskBacking.getSelectedWebinarBeanToEdit().getType().equalsIgnoreCase("Τηλε-εκπαίδευση"))
                                                {
                                                    out.println("<option selected value='Τηλε-εκπαίδευση'>Τηλε-εκπαίδευση</option>");
                                                }
                                                else
                                                {
                                                    out.println("<option value='Τηλε-εκπαίδευση'>Τηλε-εκπαίδευση</option>");
                                                }
                                                %>
                                            </select>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            while(true)
                                            {
                                                ...
                                                {
                                                    if(curTime.equalsIgnoreCase(counterdeskBacking.getSelectedWebinarBeanToEdit().getStartDateStr("HH:mm")))
                                                    {
                                        ...
                                        <td>
                                            ...
                                            while(true)
                                            {
                                                ...
                                                if(reqDateCal.get(Calendar.HOUR_OF_DAY)>6 && reqDateCal.get(Calendar.HOUR_OF_DAY)<=23)
                                                {
                                                    if(curTime.equalsIgnoreCase(counterdeskBacking.getSelectedWebinarBeanToEdit().getEndDateStr("HH:mm")))
                                                    {
                                                        out.println("<option selected value='"+curTime+"'>"+curTime+"</option>");
                                                    }
                                                    else
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="10" align="left">
                                            <input type="text" name="webinarSubject" value="<%= counterdeskBacking.getSelectedWebinarBeanToEdit().getSubject() %>" style="width: 700px;"/>
                                        </td>
                                    </tr>
                                    <tr><td colspan="10">&nbsp;</td></tr>
                                    <tr>
                                        ...
                                        <td colspan="10" align="left">
                                            <input type="text" name="webinarOrganizer" value="<%= counterdeskBacking.getSelectedWebinarBeanToEdit().getOrganizer() %>" style="width: 700px;"/>
                                        </td>
                                    </tr>
                                    <tr><td colspan="10">&nbsp;</td></tr>
                                    <tr>
                                        <td colspan="10">
                                            ...
                                            <br/>
                                            <textarea style="width: 100%;" rows="6" name="webinarDescription"><%= counterdeskBacking.getSelectedWebinarBeanToEdit().getDescription() %></textarea>
                                        </td>
                                    </tr>
                                    <tr><td colspan="10">&nbsp;</td></tr>
                                    <tr>
                                        ...
                                        <td colspan="10">
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                for(int i=0; i<stisList.size(); i++)
                                                {
                                                    ...
                                                    out.println("<td>");
                                                        boolean found=false;
                                                        for(StisBean selectedStisBean : counterdeskBacking.getSelectedWebinarBeanToEdit().getStisList())
                                                        {
                                                            if(selectedStisBean.getId().equals(curStis.getId()))
                                                            {
                                                                found=true;
                                                                break;
                                                            }
                                                        ...
                                                        if(found)
                                                        {
                                                            out.println("<input checked='true' type='checkbox' name='stis#"+curStis.getId()+"' /> ");
                                                        }
                                                        else
                                                        {
                                                            out.println("<input type='checkbox' name='stis#"+curStis.getId()+"' /> ");
                                                        }
                                        ...
                                        <td colspan="10">
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                for(int i=0; i<sitesList.size(); i++)
                                                {
                                                    ...
                                                    out.println("<td>");
                                                        boolean found=false;
                                                        for(siteBean selectedSiteBean : counterdeskBacking.getSelectedWebinarBeanToEdit().getSitesList())
                                                        {
                                                            if(selectedSiteBean.getId().equals(curSite.getId()))
                                                            {
                                                                found=true;
                                                                break;
                                                            }
                                                        ...
                                                        if(found)
                                                        {
                                                            out.println("<input checked='true' type='checkbox' name='site#"+curSite.getId()+"' /> ");
                                                        }
                                                        else
                                                        {
                                                            out.println("<input type='checkbox' name='site#"+curSite.getId()+"' /> ");
                                                        }
                            ...
                            {
                                out.println(langBacking.getLiteral("invalid_webinar_selection"));
                            }
                            %>
                        </div>               
                    </div>               
    ...
    <script type="text/javascript">
        ...
        date: '<%= counterdeskBacking.getSelectedWebinarBeanToEdit().getStartDateStr(langBacking.getDateFormat()) %>',
        //date: '12/8/2012',
        //dateFormat: 'dddd',
        showTrigger: true
        });
