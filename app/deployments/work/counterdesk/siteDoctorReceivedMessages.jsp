	...
	<div id="page">
            <div id="page-bgtop">
                <div id="content">
                    ...
                    ArrayList<MessageBean> recentMessages = counterdeskBacking.getRecentMessagesByAccountId(accId);
                    for(int i=0; i<recentMessages.size(); i++)
                    {
                        MessageBean curMsg = recentMessages.get(i);
                        String curColor="navy";
                        if(curMsg.getFromAccountBean().id.equals(counterdeskBacking.getAB().id))
                        {
                            curColor="#EEEEEE";
                        }
                        else
