	...
	<div id="page">
		...
		<div id="content">
                    ...
                    <div class="post" id="newModalityFormDiv">
                        <h2 class="title">
                            <a href="#"><%= langBacking.getLiteral("add_department") %></a>
                        </h2>
                        <div class="entry">
                            <form id="addDepartmentForm" method="post" action="actions/add_department_action.jsp">
                                <table border="0">
                                    <tr>
                                        <td align="right">
                                        ...
                                        <td>
                                            <input name="departName" type="text" size="53" value="<%= siteAdminBacking.getNewDepartmentBean().getName() %>"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><%= langBacking.getLiteral("comment") %>:</td>
                                        <td>
                                            <textarea name="departComment"  rows="2" cols="50"><%= siteAdminBacking.getNewDepartmentBean().getComments() %></textarea>
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            <%
                                            if(siteAdminBacking.getNewDepartmentBean().getActive().equalsIgnoreCase("false"))
                                            {
                                    ...
                                    <td align="center" colspan="2">
                                        <input type="button" value="<%= langBacking.getLiteral("save") %>" onClick="javascript:checkNewDepartmentForm();"/>
                                    </td>
                                    </tr>
                                </table>
                            </form>
