...
ManagerBacking managerBacking=(ManagerBacking)session.getAttribute("managerBacking");
%>
...
<body onload="resetCalendar()">
	...
	<div id="page">
		...
		<div id="content" style="width:100%">
                    ...
                    <%
                    if(managerBacking!=null && managerBacking.getErrorMessage().length()>0)
                    {
                        ...
                        out.println(managerBacking.getErrorMessage());
                        out.println("</td></tr></table>");
                        out.println("</div>");
                    }
                    else if(managerBacking!=null && managerBacking.getOkMessage().length()>0)
                    {
                        out.println("<div class='post'>");
                        out.println("<table border=0 style='border: 1px solid grey; width:1000px;'><tr><td valign='middle' width='70px'>");
                        out.println("<img src='../images/check.png' width='64px'/>");
                        out.println("</td><td valign='middle'>");
                        out.println(managerBacking.getOkMessage());
                        out.println("</td></tr></table>");
                        out.println("</div>");
                    }
                    else if(managerBacking!=null && managerBacking.getInfoMessage().length()>0)
                    {
                        out.println("<div class='post'>");
                        out.println("<table border=0 style='border: 1px solid grey; width:1000px;'><tr><td valign='middle' width='70px'>");
                        out.println("<img src='../images/info.png' width='64px'/>");
                        out.println("</td><td valign='middle'>");
                        out.println(managerBacking.getInfoMessage());
                        out.println("</td></tr></table>");
                        out.println("</div>");
                    }
                    managerBacking.resetMessages();
                    %>
